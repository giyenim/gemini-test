...
/**
 * 점 하나가 화면에서 차지하는 크기 (px) — 쪽 넘김 버튼의 점(8.6)과 같은 자리.
 * 시험지를 확대하지 않으므로(`SHEET_ZOOM` = 1) 여기 적은 값이 곧 화면 크기다.
 */
const DOT_PX = 8.9
 ...
 *
 * 상태와 가른 것은 확인 단계가 4초면 저절로 풀려 그 모양을 잡는 동안 자꾸
 * 달아나기 때문이다. 이렇게 두면 두 단계를 나란히 세워 두고 그릴 수 있다.
 */
