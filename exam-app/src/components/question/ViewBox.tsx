...
export function ViewBox({ title, body }: ViewBoxProps) {
  return (
    ...
    >
      ...
      <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white text-[12px] leading-none font-normal [word-spacing:0.45em]">
        &lt;{title}&gt;
      </span>
      <div className="px-2 pt-[10px] pb-1.5 text-[12px] font-normal leading-[1.5]">
        <BodyLines body={body} />
      </div>
    </aside>
  )
